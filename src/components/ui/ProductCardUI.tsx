...
export const ProductCardUI = ({ product }: ProductCardUIProps) => {
  return (
    <HeadlessProductCard product={product}>
      {(logic) => (
        <Card className="y2k-card hover:scale-105 transition-transform duration-300">
          <CardContent className="p-4">
              ...
              <div className="aspect-square bg-muted rounded-xl mb-3 overflow-hidden relative">
                ...
                <div className="absolute top-2 left-2 flex flex-col gap-1">
                  ...
                  {logic.product.featured && (
                    <span className="bg-primary text-background text-xs px-2 py-1 rounded font-medium">
                      Featured
                    </span>
                  )}
                  {!logic.inStock && (
            ...
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                className="border-primary/50 hover:bg-primary hover:text-background font-semibold disabled:opacity-50"
              >
